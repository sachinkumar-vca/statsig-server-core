...
namespace Statsig
{
    internal static unsafe partial class StatsigFFI
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void statsig_initialize_with_details_callback_delegate(byte* result);
        ...
        internal static extern void statsig_initialize_with_details(ulong statsig_ref, statsig_initialize_with_details_callback_delegate callback);

        [DllImport(__DllName, EntryPoint = "statsig_initialize_with_details_blocking", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* statsig_initialize_with_details_blocking(ulong statsig_ref);
        ...
        internal static extern byte* statsig_get_parameter_store_with_options(ulong statsig_ref, byte* parameter_store_name, byte* options_json, ulong* inout_result_len);
        ...
        internal static extern byte* statsig_get_string_parameter_from_parameter_store(ulong statsig_ref, ulong user_ref, byte* parameter_store_name, byte* param_name, byte* default_value, byte* options_json, ulong* inout_result_len);
        ...
        internal static extern byte* statsig_get_object_parameter_from_parameter_store(ulong statsig_ref, ulong user_ref, byte* parameter_store_name, byte* param_name, byte* @default, byte* options_json, ulong* inout_result_len);
        ...
        internal static extern byte* statsig_get_array_parameter_from_parameter_store(ulong statsig_ref, ulong user_ref, byte* parameter_store_name, byte* param_name, byte* @default, byte* options_json, ulong* inout_result_len);
        ...
        [DllImport(__DllName, EntryPoint = "statsig_get_raw_dynamic_config", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* statsig_get_raw_dynamic_config(ulong statsig_ref, ulong user_ref, byte* config_name, byte* options_json, ulong* inout_result_len);
        ...
        internal static extern byte* statsig_get_experiment_groups(ulong statsig_ref, byte* experiment_name, ulong* inout_result_len);
        ...
        [DllImport(__DllName, EntryPoint = "statsig_get_raw_layer", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* statsig_get_raw_layer(ulong statsig_ref, ulong user_ref, byte* layer_name, byte* options_json, ulong* inout_result_len);

        [DllImport(__DllName, EntryPoint = "log_layer_param_exposure_from_raw", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern void log_layer_param_exposure_from_raw(ulong statsig_ref, byte* layer_json, byte* param_name);
        ...
        [DllImport(__DllName, EntryPoint = "statsig_get_parameter_names_from_store", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        internal static extern byte* statsig_get_parameter_names_from_store(ulong statsig_ref, ulong user_ref, byte* parameter_store_name, ulong* inout_result_len);
